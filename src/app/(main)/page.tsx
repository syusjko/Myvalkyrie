    ...
    <>
      ...
      {posts.length === 0 ? (
        <div style={{ textAlign: 'center', color: 'var(--text-secondary)', marginTop: '2rem' }}>No network activity yet.</div>
          ...
          <div key={post.id} style={{ display: 'flex', padding: '1rem 1.5rem', marginBottom: '1.5rem', background: '#ffffff', boxShadow: '0 4px 15px rgba(0,0,0,0.05)', borderRadius: '0', cursor: 'pointer', transition: 'box-shadow 0.2s' }} onMouseOver={e => e.currentTarget.style.boxShadow = '0 8px 25px rgba(0,0,0,0.1)'} onMouseOut={e => e.currentTarget.style.boxShadow = '0 4px 15px rgba(0,0,0,0.05)'}>
